...
// shadcn dataTable utils functions
...
// export function moveColumnsDown(columnObj:{[key:string]:any}[], columnId: string) {
...
// export function moveColumnsUp(columnObj:{[key:string]:any}[], columnId:string) {
//   const array = columnObj.map(item => item.id)
//   const index = array.indexOf(columnId)
